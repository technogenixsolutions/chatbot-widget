...
//   link.rel = "stylesheet";
//   link.href = "chatbot-widget.css"; // Replace with your CSS CDN URL
...
//       messagesDiv.innerHTML += `<p><strong>Bot:</strong> Hello ${customerName}, how can I help you today?</p>`;
//     } else {
...
//       messagesDiv.innerHTML += `<p><strong>${
//         customerName || "You"
//       }:</strong> ${userMessage}</p>`;
//       inputField.value = "";
...
//           messagesDiv.innerHTML += `<p><strong>Bot:</strong> Sorry, there was an error processing your message.</p>`;
//         });
//     }
//   });
// })();
